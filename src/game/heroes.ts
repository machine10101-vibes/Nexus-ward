...
export const HEROES: Record<HeroId, HeroDef> = {
  fighter: {
    ...
    abilityCd: 16,
    ability: "Cleave",
    abilityHint: "Sweep the blade. Heavy hits on every host in reach.",
    arts: [
      { name: "Cleave", hint: "Sweep the blade. Heavy hits on every host in reach.", cd: 16 },
      { name: "Guard Break", hint: "Slam the grid. Soft damage, long slow on the pack.", cd: 18 },
      { name: "Ion Rush", hint: "Face the nearest threat and cut the lane in a line.", cd: 20 },
    ],
    hitsFlying: false,
    kind: "shell",
  ...
  ranger: {
    ...
    abilityCd: 14,
    ability: "Volley",
    abilityHint: "Three hard shots into the closest hosts, air included.",
    arts: [
      { name: "Volley", hint: "Three hard shots into the closest hosts, air included.", cd: 14 },
      { name: "Rail Pin", hint: "Pierce the facing line and pin what it hits.", cd: 16 },
      { name: "Suppress", hint: "Walk weak fire across the pack and slow their step.", cd: 12 },
    ],
    hitsFlying: true,
    kind: "bolt",
  ...
  mage: {
    ...
    arts: [
      ...
      { name: "Rift Well", hint: "Open a hold. Damages the pocket and slows what stands in it.", cd: 22 },
    ],
    hitsFlying: true,
    kind: "beam",
